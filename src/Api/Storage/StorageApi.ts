...
{
	public static clear(storageProvider: Storage): void
	{
	...
	public static get(key: string, storageProvider: Storage): any
	{
		...
		if (storageItemRawValue === null || storageItemRawValue === undefined) return null;
	...
	public static remove(key: string, storageProvider: Storage): void
	{
