...
/******/ 	return __webpack_require__(__webpack_require__.s = "./exports/Core/Http.ts");
/******/ })
/************************************************************************/
/******/ ({
...
Object.defineProperty(exports, "__esModule", { value: true });
var Http_1 = __webpack_require__(/*! ../../src/Core/Http/Http */ "./src/Core/Http/Http.ts");
module.exports = Http_1.Http;
...
Object.defineProperty(exports, "__esModule", { value: true });
var HttpRequest_1 = __webpack_require__(/*! ./HttpRequest */ "./src/Core/Http/HttpRequest.ts");
var HttpApi_1 = __webpack_require__(/*! ./HttpApi */ "./src/Core/Http/HttpApi.ts");
...
Object.defineProperty(exports, "__esModule", { value: true });
var HttpRequest_1 = __webpack_require__(/*! ./HttpRequest */ "./src/Core/Http/HttpRequest.ts");
var AxiosHttpProvider_1 = __webpack_require__(/*! ./Provider/Axios/AxiosHttpProvider */ "./src/Core/Http/Provider/Axios/AxiosHttpProvider.ts");
var HttpResponseCache_1 = __webpack_require__(/*! ./HttpResponseCache */ "./src/Core/Http/HttpResponseCache.ts");
var Objects_1 = __webpack_require__(/*! ../Objects/Objects */ "./src/Core/Objects/Objects.ts");
var HttpApi = /** @class */ (function () {
    function HttpApi() {
    }
    HttpApi.makeHttpRequest = function (httpRequest, cacheExpiry) {
        if (cacheExpiry === void 0) { cacheExpiry = null; }
        var validMethods = ['get', 'post', 'put', 'delete', 'options'];
        ...
        var cachedResponse = HttpResponseCache_1.HttpResponseCache.getCachedResponseByRequest(httpRequest);
        if (cachedResponse) {
    ...
    HttpApi.getProvider = function () {
        if (this.httpProvider) {
            return this.httpProvider;
        }
        if (!this.defaultHttpProvider) {
            this.defaultHttpProvider = new AxiosHttpProvider_1.AxiosHttpProvider();
        }
        return this.defaultHttpProvider;
    };
    HttpApi.enableResponseCaching = function (responseCachingOptions) {
        if (responseCachingOptions === void 0) { responseCachingOptions = null; }
        if (responseCachingOptions) {
            responseCachingOptions = Objects_1.Objects.merge(this.responseCachingOptions, responseCachingOptions);
        }
...
/***/ "./src/Core/Http/HttpResponseCache.ts":
/*!********************************************!*\
  !*** ./src/Core/Http/HttpResponseCache.ts ***!
  \********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var HttpResponse_1 = __webpack_require__(/*! ./HttpResponse */ "./src/Core/Http/HttpResponse.ts");
var moment_1 = __importDefault(__webpack_require__(/*! moment */ "./node_modules/moment/moment.js"));
var LocalStorage_1 = __webpack_require__(/*! ../Storage/LocalStorage */ "./src/Core/Storage/LocalStorage.ts");
var Time_1 = __webpack_require__(/*! ../Time/Time */ "./src/Core/Time/Time.ts");
var Http_1 = __webpack_require__(/*! ./Http */ "./src/Core/Http/Http.ts");
var HttpResponseCache = /** @class */ (function () {
    function HttpResponseCache() {
    }
    HttpResponseCache.getCachedResponseByRequest = function (httpRequest) {
        var cachedResponseLocalStorageKey = Http_1.Http.responseCachingOptions['localStorageKey'];
        // Get object from local storage that contains all cached response objects
        var cachedHttpResponses = LocalStorage_1.LocalStorage.get(cachedResponseLocalStorageKey);
        // If a StorageItem entity is returned
        if (cachedHttpResponses) {
            // Build key e.g. get_http://api.example.com/user
            var targetKey = httpRequest.method + '_' + httpRequest.url;
            // Get object containing cached response objects from StorageItem entity
            var httpResponses = cachedHttpResponses.value;
            // Access target key
            ...
            var httpResponseEntity = new HttpResponse_1.HttpResponse(httpRequest, cachedHttpResponse['statusCode'], cachedHttpResponse['statusText'], cachedHttpResponse['headers'], cachedHttpResponse['data'], true, moment_1.default(cachedHttpResponse['cacheExpiry']));
            // If it's expired, remove it
            if (httpResponseEntity.isExpired()) {
                // Remove key
                delete httpResponses[targetKey];
                // Store in local storage
                LocalStorage_1.LocalStorage.set(cachedResponseLocalStorageKey, httpResponses);
            }
            // Else return it
            else {
    ...
    HttpResponseCache.cacheHttpResponseAsync = function (httpResponse, cacheExpiry) {
        var self = this;
        var cachedResponseLocalStorageKey = Http_1.Http.responseCachingOptions['localStorageKey'];
        // Use set timeout to make the method async
        setTimeout(function () {
            // Get cached responses from local storage
            var cachedResponses = self.getResponseCache();
            // Build key e.g. get_http://api.example.com/user
            var httpRequest = httpResponse.httpRequest;
            var key = httpRequest.method + '_' + httpRequest.url;
            // Set cache expiry
            if (moment_1.default.isMoment(cacheExpiry)) {
                httpResponse.cacheExpiry = cacheExpiry;
            }
            else if (cacheExpiry instanceof Date) {
                httpResponse.cacheExpiry = moment_1.default(cacheExpiry.valueOf());
            }
            else {
                var expiryTimeInSeconds = Time_1.Time.timeStringToSeconds(cacheExpiry);
                var unixNow = moment_1.default().valueOf();
                var unixExpiry = unixNow + (expiryTimeInSeconds * 1000); // Multiplied by 1000 to convert to milliseconds
                httpResponse.cacheExpiry = moment_1.default(unixExpiry);
            }
            // Set httpResponse at that key
            cachedResponses[key] = httpResponse;
            // Save cached responses object in local storage
            LocalStorage_1.LocalStorage.set(cachedResponseLocalStorageKey, cachedResponses);
        }, 0);
        return this;
    };
    HttpResponseCache.clearExpiredResponsesFromCacheAsync = function () {
        var self = this;
        // Use set timeout to make the method async
        setTimeout(function () {
            // Get all cached responses from local storage
            var responseCache = self.getResponseCache();
            // For each response
            for (var key in responseCache)
                if (responseCache.hasOwnProperty(key)) {
                    var cachedResponseObject = responseCache[key];
                    var httpResponseEntity = new HttpResponse_1.HttpResponse(cachedResponseObject['httpRequest'], cachedResponseObject['statusCode'], cachedResponseObject['statusText'], cachedResponseObject['headers'], cachedResponseObject['data'], cachedResponseObject['fromCache'], moment_1.default(cachedResponseObject['cacheExpiry']));
                    // If it's expired
                    if (httpResponseEntity.isExpired()) {
                        // Remove it
            ...
            LocalStorage_1.LocalStorage.set(Http_1.Http.responseCachingOptions['localStorageKey'], responseCache);
        }, 0);
        return this;
    };
    HttpResponseCache.getResponseCache = function () {
        var cachedResponseLocalStorageKey = Http_1.Http.responseCachingOptions['localStorageKey'];
        var cachedHttpResponsesStorageItem = LocalStorage_1.LocalStorage.get(cachedResponseLocalStorageKey);
...
exports.HttpResponseCache = HttpResponseCache;


/***/ }),

/***/ "./src/Core/Http/Provider/AbstractHttpProvider.ts":
/*!********************************************************!*\
  !*** ./src/Core/Http/Provider/AbstractHttpProvider.ts ***!
  \********************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var AbstractHttpProvider = /** @class */ (function () {
...
/***/ "./src/Core/Http/Provider/Axios/AxiosHttpProvider.ts":
/*!***********************************************************!*\
  !*** ./src/Core/Http/Provider/Axios/AxiosHttpProvider.ts ***!
  \***********************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var AbstractHttpProvider_1 = __webpack_require__(/*! ../AbstractHttpProvider */ "./src/Core/Http/Provider/AbstractHttpProvider.ts");
var HttpResponse_1 = __webpack_require__(/*! ../../HttpResponse */ "./src/Core/Http/HttpResponse.ts");
var HttpError_1 = __webpack_require__(/*! ../../HttpError */ "./src/Core/Http/HttpError.ts");
var AxiosHttpProvider = /** @class */ (function (_super) {
    ...
    AxiosHttpProvider.prototype.makeHttpRequest = function (httpRequest) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if ((httpRequest.method.toLowerCase() == 'get' || httpRequest.method.toLowerCase() == 'delete')
            ...
            promise.then(function (axiosResponse) {
                ...
                var phusionResponse = new HttpResponse_1.HttpResponse(httpRequest, axiosResponse['status'], axiosResponse['statusText'], axiosResponse['headers'], axiosResponse['data'], false, null);
            ...
            promise.catch(function (axiosResponse) {
                ...
                var phusionResponse = new HttpError_1.HttpError(axiosResponse['code'], axiosResponse['message']);
...
var LocalStorage = /** @class */ (function () {
    ...
    LocalStorage.set = function (key, value, expiry) {
        if (expiry === void 0) { expiry = null; }
        return StorageApi_1.StorageApi.set(key, value, expiry, window.localStorage);
    };
    return LocalStorage;
}());
...
var StorageApi = /** @class */ (function () {
    ...
    StorageApi.get = function (key, storageProvider) {
        var storageItemJson = storageProvider.getItem(key);
        ...
        var storageItemEntity = this.create(storageItemObject);
        if (storageItemEntity
            &&
    ...
    StorageApi.create = function (object) {
        var storageItem = new StorageItem_1.StorageItem();
...
/***/ "./src/Core/Storage/StorageItem.ts":
/*!*****************************************!*\
  !*** ./src/Core/Storage/StorageItem.ts ***!
  \*****************************************/
/*! no static exports found */
...
var StorageItem = /** @class */ (function () {
    ...
    StorageItem.prototype.isExpired = function () {
        if (!this.expiry) {
            return false;
        }
