...
/******/ 	return __webpack_require__(__webpack_require__.s = "./exports/Core/Config.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./exports/Core/Config.ts":
/*!********************************!*\
  !*** ./exports/Core/Config.ts ***!
  \********************************/
...
Object.defineProperty(exports, "__esModule", { value: true });
var Config_1 = __webpack_require__(/*! ../../src/Core/Config/Config */ "./src/Core/Config/Config.ts");
...
/******/
/******/ 	// Load entry module and return exports
/******/ 	return __webpack_require__(__webpack_require__.s = "./exports/Core/Cookies.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./exports/Core/Cookies.ts":
/*!*********************************!*\
  !*** ./exports/Core/Cookies.ts ***!
  \*********************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var Cookies_1 = __webpack_require__(/*! ../../src/Core/Cookies/Cookies */ "./src/Core/Cookies/Cookies.ts");
module.exports = Cookies_1.Cookies;
    ...
    Cookies.set = function (key, value, expiry, domain, path) {
        ...
        if (expiry) {
            ...
            // If expiry is a string
                ...
                var timeInSeconds = Time_1.Time.timeStringToSeconds(expiry);
                var now = new Date();
...
/******/
/******/ 	// Load entry module and return exports
/******/ 	return __webpack_require__(__webpack_require__.s = "./exports/Core/Event.ts");
/******/ })
/************************************************************************/
/******/ ({
...
var HttpApi = /** @class */ (function () {
    ...
    HttpApi.makeHttpRequest = function (httpRequest) {
...
/******/
/******/ 	// Load entry module and return exports
/******/ 	return __webpack_require__(__webpack_require__.s = "./exports/Core/SessionStorage.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/******/
/******/ 	// Load entry module and return exports
/******/ 	return __webpack_require__(__webpack_require__.s = "./exports/Core/Strings.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/******/
/******/ 	// Load entry module and return exports
/******/ 	return __webpack_require__(__webpack_require__.s = "./exports/Core/Time.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/******/
/******/ 	// Load entry module and return exports
/******/ 	return __webpack_require__(__webpack_require__.s = "./exports/Core/UserAgent.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./exports/Core/UserAgent.ts":
/*!***********************************!*\
  !*** ./exports/Core/UserAgent.ts ***!
  \***********************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var UserAgent_1 = __webpack_require__(/*! ../../src/Core/UserAgent/UserAgent */ "./src/Core/UserAgent/UserAgent.ts");
module.exports = UserAgent_1.UserAgent;
...
/***/ "./src/Core/UserAgent/UserAgent.ts":
/*!*****************************************!*\
  !*** ./src/Core/UserAgent/UserAgent.ts ***!
  \*****************************************/
/*! no static exports found */
...
var UserAgent = /** @class */ (function () {
    ...
    UserAgent.getMajorBrowserVersion = function () {
        return parseInt(this.provider['browser']['major']);
    };
    UserAgent.getOsName = function () {
        return this.provider['os']['name'] ? this.provider['os']['name'] : null;
    };
    UserAgent.getOsVersion = function () {
    ...
    UserAgent.provider = __webpack_require__(/*! ua-parser-js */ "./node_modules/ua-parser-js/src/ua-parser.js")(navigator.userAgent);
    return UserAgent;
}());
...
/******/ });
//# sourceMappingURL=UserAgent.map